...
import static ru.geekbrains.lesson3.FuelType.Gasoline;

public class MiniVan extends Car implements Fueling {

    private Refueling refueling;
    private WashingStation washing;

    public MiniVan(String make, String model, Color color) {
